...
namespace ChatRoom.Server.Hubs
{
    public class ChatHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            await Clients.All.SendAsync("OnlineUserJoined", s_onlineUsers, _nicknameGenerator.Generate(Context.ConnectionId).ToString()).ConfigureAwait(false);
        ...
        public override async Task OnDisconnectedAsync(Exception exception)
        {
            ...
            await Clients.All.SendAsync("OnlineUserLeaved", s_onlineUsers, _nicknameGenerator.Generate(Context.ConnectionId).ToString()).ConfigureAwait(false);
